# !/usr/bin/env python3
# -*- coding:utf-8 -*-
# @Time         : 2020/3/30 13:50
# @Author       : Huanhuan sun
# @Email        : sun58454006@163.com
# @File         : update_store.py
# @Software     : PyCharm
# @Project      : normal
...
# http://pypi.hustunique.com/simple/            华中理工源
# http://pypi.sdutlinux.org/simple/             山东理工源
# http://pypi.mirrors.ustc.edu.cn/simple/       中科大的源

g = getstatusoutput('pip list --outdated -i https://mirrors.aliyun.com/pypi/simple/')    # 更改为***的源
